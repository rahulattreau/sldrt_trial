...
RT_MODEL_check_serial_2msg_processor_2_T *check_serial_2msg_processor_2(void)
{
  ...
  /* External mode info */
  check_serial_2msg_processor_2_M->Sizes.checksums[0] = (2884747981U);
  check_serial_2msg_processor_2_M->Sizes.checksums[1] = (1503829037U);
  check_serial_2msg_processor_2_M->Sizes.checksums[2] = (2298944171U);
  check_serial_2msg_processor_2_M->Sizes.checksums[3] = (560097388U);
  ...
  check_serial_2msg_processor_2_M->Sizes.numBlocks = (91);/* Number of blocks */
  check_serial_2msg_processor_2_M->Sizes.numBlockIO = (33);/* Number of block outputs */
  check_serial_2msg_processor_2_M->Sizes.numBlockPrms = (47);/* Sum of parameter "widths" */

...
MODEL                := check_serial_new_arduino_time
MODULES              := check_serial_new_arduino_time_data.c check_serial_new_arduino_time_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := check_serial_new_arduino_time.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := check_serial_new_arduino_time_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/software/desktop_realtime/test_outputting;C:/software/desktop_realtime/test_outputting/check_serial_new_arduino_time_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
